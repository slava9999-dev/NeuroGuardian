...
| get_marketplace_accounts | Список магазинов |
| update_prices | Изменить цены (требует подтверждения) |
| update_stocks | Изменить остатки FBS (требует подтверждения) |
| set_stop_loss | Включить защиту цены (требует подтверждения) |
| bulk_protect_products | Массовая защита товаров (требует подтверждения) |
