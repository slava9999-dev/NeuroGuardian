...
const TUTORIAL_STEPS = [
  ...
  },
  {
    ...
    content: 'Для каждого товара установите минимальную цену:',
    steps: [
      '1. Найдите товар в списке',
      '2. Нажмите на поле "Min Price"',
      '3. Введите минимальную допустимую цену',
      '4. Цена сохранится автоматически',
    ],
    tip: '💡 Рекомендуем ставить цену = себестоимость + минимальная маржа',
  },
  {
    id: 6,
