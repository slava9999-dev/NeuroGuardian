...
export async function executeAgentTool(
  ...
  switch (toolName) {
    ...
    case 'get_marketplace_info': {
      const { marketplace = 'both', topic } = args;
      ...
      const info: Record<string, any> = {
        commissions: {
          WB: {
            ...
            items: [
              'Базовая комиссия: 5-15% (зависит от категории)',
              'Одежда/Обувь: 11-15%',
              'Электроника: 5-12%',
              'Косметика: 10-15%',
              'Товары для дома: 12-15%',
              'Продукты питания: 8-12%',
              'Детские товары: 10-14%',
            ],
            tips: 'Актуальные комиссии смотрите в ЛК продавца → Настройки → Комиссии',
          },
          Ozon: {
            title: '💰 Комиссии Ozon',
            items: [
              'Базовая комиссия: 4-15%',
              'Premium продавцы: скидка до 2%',
              'Электроника: 4-8%',
              'Одежда: 8-12%',
              'Косметика: 10-15%',
            ],
            tips: 'Ozon часто делает скидки на комиссию для новых продавцов',
          },
        },
        logistics: {
          WB: {
            title: '📦 Логистика Wildberries',
            items: [
              'FBO (со склада WB): 30-70₽ за единицу',
              'FBS (свой склад): доставка от 45₽',
              'Хранение: 0.07₽/литр/сутки (первые 60 дней бесплатно)',
              'После 60 дней: тариф увеличивается в 2-3 раза',
              'Коробы: бесплатные, заказывать в ЛК',
            ],
            tips: 'Приёмка товара занимает 3-7 дней. Планируйте заранее!',
          },
          Ozon: {
            title: '📦 Логистика Ozon',
            items: [
              'FBO: 40-100₽ за единицу',
              'FBS: от 49₽',
              'realFBS: курьерская доставка от 199₽',
              'Хранение: первые 60 дней бесплатно',
              'Объёмный вес учитывается при расчёте',
            ],
            tips: 'Ozon более лояльный к крупногабаритным товарам',
          },
        },
        payments: {
          WB: {
            title: '💳 Выплаты Wildberries',
            items: [
              'Периодичность: каждую неделю',
              'День выплаты: обычно вторник-среда',
              'Условие: товар доставлен и подтверждён',
              'Минимальная сумма: нет ограничений',
              'Комиссия за вывод: 0%',
            ],
            tips: 'Деньги за возвраты удерживаются из следующих выплат',
          },
          Ozon: {
            title: '💳 Выплаты Ozon',
            items: [
              'Периодичность: 2 раза в неделю (вт и пт)',
              'Вывод на счёт: в течение 1-3 дней',
              'Минимальная сумма: 100₽',
              'Комиссия: 0%',
            ],
            tips: 'Ozon выплачивает чаще чем WB',
          },
        },
        returns: {
          WB: {
            title: '↩️ Возвраты Wildberries',
            items: [
              'Срок возврата для покупателя: 14 дней',
              'Обработка возврата: до 14 дней',
              'Стоимость возврата: удерживается с продавца (50-150₽)',
              'Брак: можно оспорить через поддержку',
              'Возврат на склад: товар возвращается продавцу',
            ],
            tips: 'Следите за % возвратов — влияет на рейтинг',
          },
          Ozon: {
            title: '↩️ Возвраты Ozon',
            items: [
              'Срок: 14 дней (некоторые категории до 30)',
              'Стоимость обратной логистики: от 50₽',
              'Можно установить платный возврат для покупателя',
            ],
            tips: 'Качественные фото и описание снижают возвраты на 30%',
          },
        },
        promotions: {
          WB: {
            title: '🏷️ Акции Wildberries',
            items: [
              'Принудительные акции: WB может снизить цену без согласия',
              'СПП (скидка постоянного покупателя): 3-15%',
              'Сезонные распродажи: 11.11, Чёрная пятница, Новый год',
              'Баллы: система лояльности покупателей',
            ],
            tips: '⚠️ ВАЖНО: Используйте Stop-Loss защиту от принудительных скидок!',
          },
          Ozon: {
            title: '🏷️ Акции Ozon',
            items: [
              'Акции по категориям: более гибкие условия',
              'Ozon Premium: скидки для подписчиков',
              'Баллы: начисляются покупателям',
              'Трафареты: продвижение в выдаче',
            ],
            tips: 'Участие в акциях Ozon обычно добровольное',
          },
        },
        problems: {
          WB: {
            title: '⚠️ Типичные проблемы WB',
            items: [
              '1. Принудительные скидки — цена падает без вашего согласия',
              '2. Долгая приёмка — товар лежит на складе неделями',
              '3. Потери при доставке — товар теряется',
              '4. Блокировка магазина — за нарушения правил',
              '5. Задержка выплат — деньги зависают',
            ],
            solutions: [
              'Принудительные скидки → Stop-Loss защита в NeuroAgent',
              'Долгая приёмка → Отправляйте заранее, следите за лимитами',
              'Потери → Подавайте заявки на компенсацию',
              'Блокировка → Внимательно читайте правила',
              'Задержка → Проверяйте статус в ЛК, пишите в поддержку',
            ],
          },
          Ozon: {
            title: '⚠️ Типичные проблемы Ozon',
            items: [
              '1. Блокировка карточек — ошибки в описании/фото',
              '2. Высокий % возвратов — покупатели возвращают товар',
              '3. Конкуренция — много продавцов с таким же товаром',
              '4. Низкая видимость — товар не показывается в поиске',
            ],
            solutions: [
              'Блокировка → Проверяйте требования к контенту',
              'Возвраты → Улучшите фото и описание',
              'Конкуренция → Работайте над ценой и сервисом',
              'Видимость → Используйте продвижение и отзывы',
            ],
          },
        },
        tips: {
          WB: {
            title: '💡 Лайфхаки Wildberries',
            items: [
              '📅 Лучшие дни для рекламы: понедельник-среда',
              '⏰ Пик продаж: 11:00-14:00 и 19:00-22:00',
              '📍 Региональные склады: быстрее доставка = больше продаж',
              '⭐ Рейтинг >4.5 — критически важен для видимости',
              '📸 Инфографика на главном фото увеличивает CTR на 40%',
              '🔍 SEO: используйте все 1000 символов в описании',
              '💬 Отзывы: отвечайте на все, даже негативные',
            ],
          },
          Ozon: {
            title: '💡 Лайфхаки Ozon',
            items: [
              '🎯 Трафареты — эффективный инструмент продвижения',
              '📦 FBO + FBS — комбинируйте для максимального охвата',
              '🏷️ Участвуйте в акциях — Ozon даёт бустинг участникам',
              '📊 Аналитика в ЛК — следите за конверсией',
              '⭐ Отзывы с фото — весят больше обычных',
            ],
          },
        },
        general: {
          both: {
            title: '📚 Общая информация о маркетплейсах',
            comparison: {
              WB: 'Больше трафика, но агрессивные акции',
              Ozon: 'Более лояльные условия, но меньше покупателей',
            },
            recommendations: [
              'Работайте на обоих маркетплейсах для диверсификации',
              'Используйте разные SKU для разных площадок',
              'Следите за юнит-экономикой каждого товара',
              'Защищайте маржу с помощью Stop-Loss',
            ],
          },
        },
      };

      const topicData = info[topic];
      if (!topicData) {
        return {
          data: {
            error:
              'Неизвестная тема. Доступные: commissions, logistics, payments, returns, promotions, problems, tips, general',
          },
        };
      }

      if (marketplace === 'both' || topic === 'general') {
        return { data: topicData };
      } else if (topicData[marketplace]) {
        return { data: topicData[marketplace] };
      } else {
        return { data: topicData };
      }
    }
...
Используй инструменты чтобы давать ТОЧНЫЕ данные, а не общие советы!`;
        ...
        // Добавляем историю диалога (последние 15 сообщений, сжимаем длинные)
        for (const histMsg of conversationHistory.slice(-15)) {
          if (histMsg.role === 'user' || histMsg.role === 'assistant') {
            // Сжимаем очень длинные сообщения для экономии контекста
            let content = histMsg.content;
            if (content.length > 500) {
              content = content.substring(0, 500) + '... [сокращено]';
            }
