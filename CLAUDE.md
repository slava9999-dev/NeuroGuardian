...
## 🦾 AGENTIC SKILLS (НОВЫЙ СТАНДАРТ)

Проект использует архитектуру **Agentic Skills** для расширения возможностей AI. Перед выполнением специализированных задач ВСЕГДА проверяй соответствующие инструкции в `.agent/skills/`.

### Доступные навыки:

- 🛡️ **sentinel-protection** — Логика защиты цен и анти-демпинга.
- 📊 **marketplace-api** — Глубокие знания WB/Ozon API и синхронизации.
- 👁️ **digital-vision** — Работа с BrowserEyes (визуальный парсинг).
- 📚 **rag-knowledge** — Управление базой знаний и эмбеддингами.

**Правило:** Если задача сложная и касается одной из этих областей, сначала прочитай `skill.md` в папке скилла.
