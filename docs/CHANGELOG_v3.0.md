...
4. **Viktor Margin Persona in AI Agent** (P0-CRITICAL-005) ✅
   - **System Prompt v4.1.0**: Transformed generic AI assistant into "Виктор Маржин"
...
- System prompt v4.0.0 → v4.1.0 (Viktor Margin Edition)
- General specialist v3.0.0 → v3.1.0 (Viktor Margin greetings)
...
- **Identity**: "Виктор Маржин — цифровой эксперт по защите прибыли"
...
- `src/api-lib/services/unit-economics.ts` - Enhanced with Viktor Margin warnings (v3.0.0)
- `tests/unit-economics/calculator.test.ts` - Added 6 new tests (32 total)

**Phase 1, Task 1.6 (AI Agent Persona):**

- `src/api-lib/agent/prompts/system-v4.ts` - Viktor Margin system prompt (v4.1.0)
- `src/api-lib/agent/specialists/general.ts` - Viktor Margin welcome messages (v3.1.0)
...
- [x] Task 1.6: Add Viktor Margin persona to AI agent (4 hours) ✅
